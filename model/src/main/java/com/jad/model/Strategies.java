...
public class Strategies {
    public static class SpoilerAesthetic implements IBehavior {
        public String getName() { return "Esthétique"; }
        public String getDescription() { return "aucun effet mécanique"; }
    }
    public static class SpoilerAerodynamic implements IBehavior {
        public String getName() { return "Aérodynamique"; }
        public String getDescription() { return "stabilité accrue"; }
    }
    public static class SpoilerExaggerated implements IBehavior {
        public String getName() { return "Exagéré"; }
    ...
    public static class NeonSober implements IBehavior {
        public String getName() { return "Sobre"; }
        public String getDescription() { return "lumière fixe"; }
    }
    ...
    public static class RimsPerformance implements IBehavior {
        ...
        public String getDescription() { return "accélération améliorée"; }
    }
    public static class RimsLowCost implements IBehavior {
        public String getName() { return "Low-cost"; }
        public String getDescription() { return "aucun effet"; }
    }
    public static class RimsShowOff implements IBehavior {
        public String getName() { return "Show-off"; }
        public String getDescription() { return "bruit distinctif"; }
    }
    public static class ExhaustSilent implements IBehavior {
        public String getName() { return "Silencieux"; }
    ...
    public static class ExhaustSport implements IBehavior {
        ...
        public String getDescription() { return "bruit puissant"; }
    }
